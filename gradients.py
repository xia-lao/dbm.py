...
class CG:
    def __init__(self, colorlist, steps):
        # self.__cl = linear_gradient(colorlist[0], colorlist[-1], n=steps+1)
        # print ("CG Init()", steps)
        self._cl = polylinear_gradient(colorlist, steps+3)
        # print ("CG Init:", len(self._cl['hex']))
        # print (self.__cl)
        # print "Steps = {}\nLength of colourlist: {}".format(steps, len(self.__cl['r']))
    
    def col(self, z):
        # print (z)
        a = hex_to_RGB(self._cl['hex'][z])
        # print (a)
        b = []
